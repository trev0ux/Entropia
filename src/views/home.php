	...
	<div class="container-fluid gedf-wrapper">
		<div class="row">
			<div class="col-md-3">
							...
							<div class="tab-content" id="myTabContent">
								...
								<div class="tab-pane fade" id="images" role="tabpanel" aria-labelledby="images-tab">
									<div class="form-group">
										...
										<input type="file" class="form-control-file" name="imagem" id="arquivo">
									</div>
								</div>
							</div>
				...
				<?php
					$select = "SELECT * FROM cadastro JOIN usuario JOIN avatar JOIN post ON cadastro.id_cadastro=usuario.id_cadastrofk AND avatar.id_avatar=usuario.id_avatarfk AND usuario.id_usuario=post.id_usuariofk WHERE usuario.id_usuario=post.id_usuariofk ORDER BY id_post DESC";
					...
					<div class="card gedf-card">
						<div class="card-header">
							<div class="d-flex justify-content-between align-items-center">
								<div class="d-flex justify-content-between align-items-center">
									<div class="mr-2">
										<img class="rounded-circle" width="45" src="../public/img/avatares/<?php echo  $linha['head_avatar'];?>" alt="">
									</div>
									<div class="ml-2">
										<div class="h5 m-0"><?php echo "@".$linha['usuario']; ?></div>
										<div class="h7 text-muted"><?php echo utf8_encode($linha['nome'])." ".utf8_encode($linha['sobrenome']); ?></div>
									</div>
								</div>
								<div>
									<div class="dropdown">
						...
						<div class="card-body">
							<div class="text-muted h7 mb-2"> <i class="fa fa-clock-o"></i> Postado <?php echo date("d/m", strtotime($linha['data'])); ?> às <?php echo date("H:i", strtotime($linha['hora'])); ?> </div>
							<h5 class="card-title"><?php echo utf8_encode($linha['postagem']); ?></h5>
							<?php 
								if ($linha['imagem'] == null) {
									echo "";
								}else{
							?>
							<h5 class="card-title"><img style="max-width:500px;max-height:250px;" src="../upload/<?php echo $linha['imagem']; ?>"></h5>
							<?php } ?>
						</div>
					...
					<script type="text/javascript">
						...
						<div class="hidden text-center" id="<?php echo $id; ?>">
							<form method="post" action="../controller/controller.posts.php">
								<input type="hidden" value="<?php echo $identificar; ?>">
				...
				?>	
					...
					<div class="card gedf-card">
						...
						<div class="card-body">
							<div class="text-muted h7 mb-2"> <i class="fa fa-clock-o"></i> Postado <?php echo date("d/m", strtotime($linha['data'])); ?> às <?php echo date("H:i", strtotime($linha['hora'])); ?> </div>
							<h5 class="card-title"><?php echo utf8_encode($linha['titulo']); ?></h5>
							<p class="card-text">
